...
#include "xfei_asr/qtts.h"
#include "xfei_asr/msp_cmn.h"
#include "xfei_asr/msp_errors.h"

const char* filename = "/home/riki/catkin_ws/src/nxrobo/voice_tx/bin/wav/iflytek01.wav";
const char* playwavpath = "play /home/riki/catkin_ws/src/nxrobo/voice_tx/bin/wav/iflytek01.wav";
/* wav音频头部格式 */
...
int makeTextToWave(const char* text, const char* filename)
{
	...
	/* appid 	应用ID。*/
	const char* login_params         = "appid = 5d37b274, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
